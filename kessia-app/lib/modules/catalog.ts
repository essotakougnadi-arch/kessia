...
export const MODULES: readonly ModuleEntry[] = [
  {
    ...
    icon: '💰', iconName: 'wallet', accent: '#B65A3A', status: 'LIVE', href: '/wallet', ref: '§6.1',
  },
  {
    ...
    icon: '🔄', iconName: 'tontines', accent: '#1F5D4A', status: 'LIVE', href: '/tontine', ref: '§6.4',
  },
  {
    ...
    icon: '🏪', iconName: 'business', accent: '#D6A84F', status: 'LIVE', href: '/business', ref: '§7',
  },
  {
    ...
    icon: '✨', iconName: 'ai', accent: '#7A5CC0', status: 'LIVE', href: '/ai', ref: '§17',
  },
  {
    ...
    icon: '⭐', iconName: 'score', accent: '#B65A3A', status: 'LIVE', href: '/profile/score', ref: '§6.6',
  },
  {
    ...
    icon: '🌱', iconName: 'growth', accent: '#1F5D4A', status: 'LIVE', href: '/growth', ref: '§23',
  },
  {
    ...
    icon: '🧮', iconName: 'simulator', accent: '#7A5CC0', status: 'LIVE', href: '/simulator', ref: '§20',
  },
  {
    ...
    icon: '🗓️', iconName: 'calendar', accent: '#B65A3A', status: 'LIVE', href: '/calendar', ref: '§26',
  },
  {
    ...
    icon: '⚖️', iconName: 'trust', accent: '#1F5D4A', status: 'LIVE', href: '/trust', ref: '§21',
  },
  {
    ...
    icon: '🛒', iconName: 'marketplace', accent: '#B65A3A', status: 'LIVE', href: '/marketplace', ref: '§16',
  },
  {
    ...
    icon: '🎓', iconName: 'learn', accent: '#1F5D4A', status: 'LIVE', href: '/academy', ref: '§10',
  },
  {
    ...
    icon: '🤝', iconName: 'community', accent: '#D6A84F', status: 'LIVE', href: '/community', ref: '§11',
  },
  {
    ...
    icon: '💼', iconName: 'jobs', accent: '#7A5CC0', status: 'LIVE', href: '/jobs', ref: '§12',
  },
  {
    ...
    icon: '📈', iconName: 'invest', accent: '#1F5D4A', status: 'REGULATED', href: '/invest', ref: '§13',
  },
  {
    ...
    icon: '🛡️', iconName: 'insurance', accent: '#D6A84F', status: 'REGULATED', href: '/insurance', ref: '§14',
  },
  {
    ...
    icon: '🌍', iconName: 'diaspora', accent: '#B65A3A', status: 'LIVE', href: '/diaspora', ref: '§15',
  },
  {
    ...
    icon: '🤲', iconName: 'loans', accent: '#1F5D4A', status: 'REGULATED', href: '/loans', ref: 'Hors cahier des charges initial — ajouté sur demande (maquettes utilisateur), ADR 0041',
  },
] as const;
