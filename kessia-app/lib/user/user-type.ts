...
export type UserTypeMeta = {
  ...
  label: string;
  hint: string;
  /** emoji — conservé pour d'éventuels contextes texte */
  icon: string;
  /** nom d'icône du registre components/ui/Icon */
  iconName: IconName;
...
export const USER_TYPES: readonly UserTypeMeta[] = [
  {
    key: 'INDIVIDUAL', label: 'Particulier', icon: '👤', iconName: 'profile', mvp: true, focus: ['wallet', 'tontine'],
  ...
  {
    key: 'BEGINNER_ENTREPRENEUR', label: 'Entrepreneur débutant', icon: '🚀', iconName: 'rocket', mvp: true, focus: ['tontine', 'business'],
  ...
  {
    key: 'MICRO_ENTERPRISE', label: 'Micro-entreprise', icon: '🏪', iconName: 'business', mvp: true, focus: ['business', 'wallet'],
  ...
  {
    key: 'SME', label: 'PME', icon: '🏢', iconName: 'building', mvp: true, focus: ['business', 'wallet', 'tontine'],
  ...
  {
    key: 'COOPERATIVE', label: 'Coopérative / Groupe', icon: '🤝', iconName: 'handshake', mvp: true, focus: ['tontine', 'wallet'],
  ...
  { key: 'MENTOR',            label: 'Mentor',               hint: 'Accompagner des entrepreneurs (parcours Phase 8).',          icon: '🧭', iconName: 'explore', mvp: false, focus: [], firstSteps: NONE, aiPrompts: [] },
  { key: 'TRAINER',           label: 'Formateur',            hint: 'Proposer des formations (parcours Phase 8).',                icon: '🎓', iconName: 'learn', mvp: false, focus: [], firstSteps: NONE, aiPrompts: [] },
  { key: 'SUPPLIER',          label: 'Fournisseur',          hint: 'Vendre sur KESSIA Market (parcours Phase 8).',               icon: '📦', iconName: 'package', mvp: false, focus: ['business'], firstSteps: NONE, aiPrompts: [] },
  { key: 'INSTITUTION',       label: 'Institution',          hint: 'Structure publique ou partenaire institutionnel (Phase 8).', icon: '🏛️', iconName: 'institution', mvp: false, focus: [], firstSteps: NONE, aiPrompts: [] },
  { key: 'FINANCIAL_PARTNER', label: 'Partenaire financier', hint: 'Banque, opérateur, EME partenaire (Phase 8).',               icon: '💳', iconName: 'topup', mvp: false, focus: [], firstSteps: NONE, aiPrompts: [] },
  { key: 'INSURANCE_PARTNER', label: 'Assureur partenaire',  hint: 'Assureur habilité (parcours Phase 8).',                      icon: '🛡️', iconName: 'shield', mvp: false, focus: [], firstSteps: NONE, aiPrompts: [] },
] as const;
